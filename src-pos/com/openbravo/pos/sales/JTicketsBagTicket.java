...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private void initComponents() {
        ...
        m_jButtons.setLayout(new java.awt.FlowLayout(0));
        ...
        m_jBill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/mime.png"))); // NOI18N
        m_jBill.setText("Factura");
